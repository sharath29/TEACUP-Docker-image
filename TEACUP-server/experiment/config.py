...
TPCONF_script_path = '/home/student/Documents/TEACUP/teacup'
...
# Host lists
TPCONF_router = ['192.168.50.2', ]
TPCONF_hosts = [ '172.16.10.1','192.168.50.1', ]

# Map external IPs to internal IPs
TPCONF_host_internal_ip = {
'192.168.50.2': ['172.16.10.2','192.168.50.2'],
