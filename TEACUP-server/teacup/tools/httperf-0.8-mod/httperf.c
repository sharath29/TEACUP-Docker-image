...
static struct option longopts[] =
  {
    ...
    {"client-session-offsets", no_argument, (int *) &param.session_offsets, 1},
    ...
    {"ramp-up-num-conns", required_argument, (int *) &param.ramp_up_conns, 0},
    {"ramp-down-num-conns", required_argument, (int *) &param.ramp_down_conns, 0},
#endif /* UW_STABLE_STATS */
    {"rate",	     required_argument,	(int *) &param.rate,		0},
    {"rate-interval", required_argument, (int *) &param.rate_interval, 0},
...
#endif
    {"spec-stats",   no_argument,       (int*) &param.spec_stats,       1},
    {"stagger-start", no_argument,      &param.client.stagger_start, 1},
    {"call-stats",   required_argument, (int*) &param.call_stats,       -1},
    {"call-stats-file",   required_argument, (int*) &param.call_stats_file,       0},
    {"separate-post-stats", no_argument, (int*) &param.separate_post_stats, 1},
    {"stats-interval",required_argument, (int *) &param.stats_interval,	0},
    ...
    {"use-cpu-mask", required_argument, (int *) &param.cpu_mask,	0},
#endif
    ...
    {"wsesslog-exit-early", no_argument,&param.wsesslog.exit_early,	1},
...
usage (void)
{
  printf ("Usage: %s "
...
#ifndef SRINI_RATE
          "\t[--num-calls N] [--num-conns N] [--period [d|u|e|v]T1"
          "[,D1][,T2][,D2]]\n"
#else
	  ...
	  "\t[--wsesslog N,X,file] [--wsesslog-exit-early]\n"
          "\t[--wset N,X]\n",
          prog_name);
}
...
#ifdef HAVE_SSL
/* wsesslog may have some sessions which use ssl */
  if (param.use_ssl || param.wsesslog.num_sessions)
    {
      char buf[1024];
...
#endif
  if (param.spec_stats)
    printf (" --spec_stats=%d", param.spec_stats);
